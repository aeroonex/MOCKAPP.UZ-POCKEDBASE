...
const PricingCard: React.FC<PricingCardProps> = ({ isDialog = false }) => {
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-2xl border border-border/60 bg-background/70 shadow-2xl backdrop-blur-md ring-1 ring-primary/10 dark:bg-white dark:border-white",
