...
import { ParallaxY, Rise3D } from "./motion";
...
const DarkBand: React.FC = () => {
  ...
  return (
    <section className="dark-band relative overflow-hidden py-20 text-white sm:py-28">
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-12">
          <Reveal className="lg:col-span-5">
            ...
            <h2 className="mt-3 text-3xl font-black tracking-[-0.03em] sm:text-5xl">
              {t("landing_page.band_title_a")} <span className="text-[#bef264]">{t("landing_page.band_title_hl")}</span>
            </h2>
        ...
        <div className="mt-24 grid items-center gap-12 lg:grid-cols-12">
          ...
          <Reveal className="lg:col-span-5 lg:order-2">
            ...
            <h3 className="mt-3 text-2xl font-black tracking-[-0.02em] sm:text-4xl">{t("landing_page.q_title")}</h3>
